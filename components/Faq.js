const Faq = () => {
  return (
    <div className="faq">
      <h1 className="faq_container_primary_text">Frequently Ask Question</h1>
      <h2 className="faq_container_secondary_text">
        What are you looking and find the solution on our FAQ page
      </h2>
